...
public class TakeZhajinhuaCards extends TakeCards implements Message , java.io.Serializable{
	...
	public TakeZhajinhuaCards(){}
	
	public TakeZhajinhuaCards(Player player){
	...
	public TakeZhajinhuaCards(Player player , TakeCards last){
		this(player, last, true) ;
	}
	
	public TakeZhajinhuaCards(Player player , TakeCards last , boolean take){
		this.userid = player.getPlayuser() ;
		if(last != null){
	...
	public TakeZhajinhuaCards(Player player , boolean allow , byte[] playCards){
		this.userid = player.getPlayuser() ;
		if(playCards == null){
			this.cards = getAIMostSmall(player, 0) ;
		}else{
	...
	public TakeZhajinhuaCards(Player player , byte[] tipcards){
		this.userid = player.getPlayuser() ;
		this.cards = tipcards ;
		if(this.cards!=null){
			this.cardType =  ActionTaskUtils.identification(cards);
