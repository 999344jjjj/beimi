...
import com.beimi.core.engine.game.action.zhajinhua.AutoAction;
import com.beimi.core.engine.game.action.zhajinhua.RaiseHandsAction;
import com.beimi.core.engine.game.action.zhajinhua.PlayCardsAction;
...
@Configuration
public class BeiMiZhajinhuaStateMachineConfig<T, S>  {
    ...
    public void configure(StateMachineTransitionConfigurer<String, String> transitions)
        ...
        transitions
            ...
            .withExternal()
                ...
                .event(BeiMiGameEvent.AUTO.toString()).action(new AutoAction<String,String>())
                .and()
            .withExternal()
